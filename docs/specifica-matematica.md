...
Stato: convenzioni matematiche dell'MVP approvate; estensione per risorse aggiuntive implementata e verificata. La fiscalità semplificata è implementata nel dominio fino al calcolo congiunto di target, PAC e decumulo, ma non è ancora esposta da API e interfaccia; si veda `docs/specifica-fiscalita-semplificata.md`.
